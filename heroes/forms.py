...
class MakeSpell(forms.Form):
    ...
    cells = forms.CharField(label = 'cells', max_length = 255)
    damage_type = forms.CharField(label = 'damage_type', max_length = 255)
    damage_formula = forms.CharField(label = 'damage_formula', max_length = 255)
